...
class Zend_Mime
{
    ...
    public function __construct($boundary = null)
    {
        ...
        if ($boundary === null) {
            if (defined('APPLICATION_ENV') && (APPLICATION_ENV=='testing') && !empty($GLOBALS['am_mime_boundary']))
            {
                // this fixed must be used ONLY FOR UNIT TESTING! else it will cause security issue! alex@cgi-central.net
                $this->_boundary = $GLOBALS['am_mime_boundary'];
            } else {
