    ...
    implements HTML_QuickForm2_DataSource_Submit, Serializable, Am_Mvc_Request_Interface
{
    ...
    static function createEmpty() { return new self([], self::METHOD_GET, null); }
    ...
    public function unserialize($serialized)
    {
       ...
       @$this->__construct($arr['_vars'], $arr['_method']);
        foreach (['_remoteAddr', '_requestUri', '_params', '_moduleKey', '_module', '_controllerKey', '_controller', '_actionKey', '_action'] as $k)
            $this->$k = @$arr[$k];
    }
