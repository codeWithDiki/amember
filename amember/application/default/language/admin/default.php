...
send email to user after password change',
  ...
  'Clear Invoice Log' => 'Clear Invoice Log',
...
notification will be sent in case of one of selected products exits in invoice, keep empty if you want to send for any',
  ...
  'Count all IPv4 as different' => 'Count all IPv4 as different',
  'Count all IPv6 as different' => 'Count all IPv6 as different',
...
for internal use',
  ...
  'Disable Payment System Action Log
it is impossible to troubleshoot issue with payments in event of you disable this log' => 'Disable Payment System Action Log
...
additional discount to invoice total besides coupon',
  ...
  'Display Separate Invoice for Refunds' => 'Display Separate Invoice for Refunds',
...
utilities as <em>AtomicParsley</em> or similar to check your file structure.',
  ...
  'Include Product Description to PDF Invoice' => 'Include Product Description to PDF Invoice',
...
meta data (used by search engines)',
  ...
  'Logo Image
watermark on video, logo can be a JPG or PNG file' => 'Logo Image
...
password should contain at least 2 capital letters, 2 or more numbers and 2 or more special chars',
  'Require Strong Password for Admins
password should contain at least 2 capital letters, 2 or more numbers and 2 or more special chars' => 'Require Strong Password for Admins
password should contain at least 2 capital letters, 2 or more numbers and 2 or more special chars',
...
By default module will create archived tables in the same database',
  ...
  'Use first %d blocks  to determine different IP (%s)' => 'Use first %d blocks  to determine different IP (%s)',
